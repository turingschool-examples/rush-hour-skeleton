...
class ParserTest < Minitest::Test
  ...
  def test_parse_entire_payload_and_create_payload_request_table
    ...
    assert_equal "1", parsed.id_url
    assert_equal "1", parsed.referrer
    assert_equal "1", parsed.id_request
    assert_equal "1", parsed.id_useragent
    assert_equal "1", parsed.id_resolution
    assert_equal "1", parsed.id_ip
  end
