...
class ParserTest < Minitest::Test
  ...
  def test_user_agent_gem_parses
  ...
  def test_it_can_parse_a_raw_json_payload
    ...
    assert_equal "Chrome", result["software_agent"].browser
    assert_equal "Macintosh%3B Intel Mac OS X 10_8_2", result["software_agent"].platform
