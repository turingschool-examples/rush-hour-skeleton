...
class PayloadRequestTest < Minitest::Test
  ...
  def setup
    ...
    PayloadRequest.create(url: "enewsonline.com", requested_at: "2013-02-16 21:38:28 -0700", responded_in: 10, referred_by: "facebook.com", request_type: "GET", parameters_id: 1, event_name: "search", user_agent_id: 1, resolution_id: 1, ip_id: 1)
  end
