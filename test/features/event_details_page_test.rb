...
class EventDetailsPageTest < FeatureTest
  ...
  def test_it_displays_screen_resolution_breakdown
    ...
    Payload.create({source_id: 1, url: "http://jumpstartlab.com/blog", resolution_width: "1920", resolution_height: "1280", requested_at: "2013-02-16 21:38:28 -0799", responded_in: 10})
    Payload.create({source_id: 1, url: "http://jumpstartlab.com/blog", resolution_width: "800", resolution_height: "600", requested_at: "2013-02-16 21:38:28 -0702", responded_in: 10})
