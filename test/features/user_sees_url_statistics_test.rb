...
class UrlDataTest < FeatureTest
  ...
  #   visit '/sources/jumpstartlab&rootUrl=http://jumpstartlab.com/urls/jumpstartlab.com/blog'
  #   assert_equal '/sources/jumpstartlab&rootUrl=http://jumpstartlab.com/urls/jumpstartlab.com/blog', current_path
