...
curl -i -d 'payload={"url":"http://jumpstartlab.com/tutorials","requestedAt":"2013-02-17 20:44:28 -0700","respondedIn":47,"referredBy":"http://jumpstartlab.com","requestType":"GET","parameters":[],"eventName": "socialLogin","userAgent":"Mozilla/5.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"1920","resolutionHeight":"1280","ip":"63.29.38.211"}' http://localhost:9393/sources/jumpstartlab/data
...
curl -i -d 'payload={"url":"http://apple.com/store","requestedAt":"2014-02-17 16:38:28 -0700","respondedIn":75,"referredBy":"http://google.com","requestType":"GET","parameters":[],"eventName": "socialLogin","userAgent":"Mozilla/5.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"640","resolutionHeight":"480","ip":"63.29.38.212"}' http://localhost:9393/sources/apple/data
